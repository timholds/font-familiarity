...
CMD ["gunicorn", "--bind", "0.0.0.0:8000", "--workers", "2", "--threads", "4", "--timeout", "30", "--log-level", "info", "frontend_app:create_app('/app/model/fontCNN_BS64-ED1024-IC16.pt', '/app/model', '/app/model/class_embeddings_1024d.npy', 'label_mapping_char.npy')"]