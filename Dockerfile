...
CMD ["gunicorn", "--bind", "0.0.0.0:8000", "--workers", "2", "--threads", "4", "--timeout", "30", "--log-level", "info", "frontend_app:create_app('/app/model/fontCNN-BS64-ED1024-IC16-PS64-NH16.pt', '/app/model', '/app/model/class_embeddings-BS64-ED1024-IC16-PS64-NH16.npy', 'label_mapping.npy', 'True')"]