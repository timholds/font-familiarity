...
CMD ["gunicorn", "--bind", "0.0.0.0:8000", "--workers", "2", "--threads", "4", "--timeout", "30", "--log-level", "info", "frontend_app:create_app('/app/model/fontCNN-BS32-ED512-IC16-PS64-NH8-PX0.05-PY0.15-epoch10-C.3.pt', '/app/model', '/app/model/class_embeddings-BS32-ED512-IC16-PS64-NH8-PX0.05-PY0.15-epoch10-C.3.npy', 'label_mapping.npy', 'True')"]